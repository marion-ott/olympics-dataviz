...
class Dashboard extends React.Component {
    ...
    noFemale = () => {
      if (this.props.data.game[0].female === 0) {
        console.log('no femme')
      }
    }
                ...
                <div className="Dashboard_athletes">
                    <div className="top">
                        <h4>La parité aux<br/>Jeux Olympiques de {this.props.data.game[0].year}</h4>
                          ...
                          <div className="Dashboard_athletes_text">
                            ...
                            {this.props.data.game[0].female != 0 ? (
                            <div className="stats">
                    ...
                    <div className="bottom">
                      ...
                      {this.props.data.game[0].female != 0 ? (
                        ...
                        <div className="Dashboard_athletes_graph_noFemale">
                          <div className="noFemale">
                            <span>Pour le premier jeu, en <strong>1896</strong> aucun pays n'a présenté de femme aux Jeux Olympiques</span>
                          </div>
                        </div>
                      )}
                    </div>
